  ...
  <a-card>
    <a-form>
      ...
      <a-form-item label="Tel No" class="register-form-item">
        <a-input disabled placeholder="Tel No" v-model="form.taxpayer.contact_details.telno" />
      </a-form-item>
      ...
      <span v-if="form.taxpayer.taxpayer_type == 'C'">
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-select disabled style="width: 100%" v-model="form.taxpayer.start_month">
      ...
      <span v-else>
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-radio-group disabled v-model="form.taxpayer.filer_type">
      ...
      <a-form-item
        ...
        has-feedback
      >
        <a-input disabled placeholder="Zip Code" v-model="form.taxpayer.address_details.zipCode"></a-input>
      </a-form-item>
    </a-form>
    <!-- <a-divider></a-divider>
    <a-row>
...
export default {
  ...
  created() {
    this.form.taxpayer = this.deepCopy(
      this.$store.state.tax_form.view_taxpayer
    );
