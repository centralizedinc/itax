<template>
  <div>
    ...
    <a-form :form="form_part1" v-show="step===1">
      ...
      <a-form-item label="13. Less: Tax Remitted in Return Previously filed, if this is an amended return ">
...
export default {
  ...
  watch: {
    form(){
      console.log("created taxpayer data: "+JSON.stringify(this.form.taxpayer))
    }
    // step() {
    //   if (this.step < 0) {
    //     this.$router.push("/");
