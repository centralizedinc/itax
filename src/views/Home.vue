<template>
  <a-layout >
    ...
    <a-layout-footer style="background: linear-gradient(to right, #000046, #1cb5e0); color: #ffffff">
      <a-row>
        <a-col :span="24">
          <h1 style="color:#ffffff">Get in touch</h1>
          <!-- <a-divider></a-divider> -->
          <p><a-icon type="phone"></a-icon> Hotline: 123-3456</p>
          <p><a-icon type="facebook"></a-icon> Facebook: <a style="color:#ffffff" href="https://www.facebook.com/RoderickDondonAlcala/">itax.ph</a></p>
          <a-divider></a-divider>
        </a-col>
    ...
    <a-modal v-model="signup_visible" title="Register">
        <a-row type="flex" justify="center" :gutter="16">
          <a-col :span="24">
            <p>Register using facebook or google</p>
          </a-col>
          <a-col :span="12">             
