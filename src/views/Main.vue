  ...
  <a-layout style="background: linear-gradient(to top, #8e9eab, #eef2f3);">
    ...
    <a-layout-content>
      <a-row
        ...
        justify="center"
      >
        <a-col :span="4" v-if="session_mode==='SETUP'">
        ...
        <a-col :span="session_mode==='SETUP' ? 15 : 20" style="margin-left:2vw; margin-right:2vw">
          <a-row>
            <a-col :span="24">
...
export default {
  ...
  computed: {
    ...
    session_mode(){
      return this.$store.state.account_session.account.mode;
    }
  }
};
</script>
