    ...
    content.push({
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {
                            text: forms.email == null ? ' ' : forms.email,
                            // text: '0 0 0',
                            fontSize: 15,
                            // right,down,left,up
                            alignment: 'justify',
        ...
        },
        {
            ...
            table: {
                ...
                body: [
                    [
                        {
                            text: forms.contact_number == null ? ' ' : forms.contact_number,
                            fontSize: 12,
                            // right,down,left,up
                            alignment: 'justify',
                            margin: [8, 3, 0, 0]
        ...
        },
        {
            ...
            table: {
                ...
                body: [
                    [
                        {
                            text: forms.claiming_add_exemp == true ? 'X' : ' ',
                            fontSize: 12,
                            // right,down,left,up
                            alignment: 'justify',
                            margin: [161, -2, 0, 0]
                        ...
                        {
                            text: forms.claiming_add_exemp == false ? 'X' : ' ',
                            fontSize: 12,
                            // right,down,left,up
                            alignment: 'justify',
                            margin: [32, -2, 0, 0]
                        ...
                        {
                            // text: forms.year ? forms.year : ' ',
                            text: forms.no_dependents == null ? ' ' : forms.no_dependents,
                            fontSize: 12,
                            // right,down,left,up
                            alignment: 'justify',
                            margin: [238, -1, 0, 0]
            ...
            table: {
                ...
                body: [
                    [{
                        // 72 characters 
                        text: forms.spouse_last == null ? ' ' : forms.spouse_last,
                        fontSize: 12,
                        // right,down,left,up
                        alignment: 'justify',
                        margin: [5, 13, 0, 0]
                    ...
                    {
                        // 72 characters 
                        text: forms.spouse_first== null ? ' ' : forms.spouse_first,
                        fontSize: 12,
                        // right,down,left,up
                        alignment: 'justify',
                        margin: [10, 13, 0, 0]
                    ...
                    {
                        // 72 characters 
                        text: forms.spouse_mi == null ? ' ' : forms.spouse_mi,
                        fontSize: 12,
                        // right,down,left,up
                        alignment: 'justify',
                        margin: [15, 13, 0, 0]
        ...
        }, 
        {
            ...
            table: {
                ...
                body: [
                    [{
                        text: forms.spouse_tin == null ? ' ' : forms.spouse_tin,
                        fontSize: 13,
                        // right,down,left,up
                        alignment: 'justify',
                        margin: [75, -2, 0, 0]
                    ...
                    {
                        // 72 characters 
                        text: forms.spouse_contact_number == null ? ' ' : forms.spouse_contact_number,
                        fontSize: 13,
                        // right,down,left,up
                        alignment: 'justify',
                        margin: [20, -2, 0, 0]
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {
                            text: forms.spouse_email == null ? ' ' : forms.spouse_email,
                            // text: '0 0 0',
                            fontSize: 12,
                            // right,down,left,up
                            alignment: 'justify',
